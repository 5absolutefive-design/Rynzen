...
const T: Record<string, Record<string, string>> = {
  ...
  fr: { searchPlaceholder: "Rechercher avec", quickAccess: "Accès rapide", customize: "Personnaliser", gmail: "Gmail", images: "Images", footer: "SearchHub — Recherchez partout, tout en un", showAllSettings: "Afficher tous les paramètres", language: "Langue", darkMode: "Mode sombre", tabAppearance: "Apparence de l'onglet", hideSettingsIcon: "Masquer l'icône", general: "Général", system: "Système", light: "Clair", dark: "Sombre", timeAndDate: "Heure et Date", enable: "Activer", showSeconds: "Afficher les secondes", analogClock: "Horloge analogique", clockShape: "Forme de l'horloge", clockFace: "Cadran", clockHands: "Aiguilles", clockBackground: "Fond de l'horloge", clockBorder: "Bordure", dateFormat: "Format de date", clockSize: "Taille de l'horloge", dateSize: "Taille de la date", worldClocks: "Horloges mondiales", timeZone: "Fuseau horaire", show: "Afficher", clockAndDate: "Horloge et date", clockOnly: "Horloge seule", dateOnly: "Date seule", automatic: "Automatique", dayMonthDate: "Jour, mois date", monthDayYear: "Mois jour, année", ddmmyyyy: "JJ/MM/AAAA" },
  ...
  pt: { searchPlaceholder: "Pesquisar com", quickAccess: "Acesso rápido", customize: "Personalizar", gmail: "Gmail", images: "Imagens", footer: "SearchHub — Pesquise em qualquer lugar, tudo em um", showAllSettings: "Mostrar todas as configurações", language: "Idioma", darkMode: "Modo escuro", tabAppearance: "Aparência da guia", hideSettingsIcon: "Ocultar ícone", general: "Geral", system: "Sistema", light: "Claro", dark: "Escuro", timeAndDate: "Hora e Data", enable: "Ativar", showSeconds: "Mostrar segundos", analogClock: "Relógio analógico", clockShape: "Formato", clockFace: "Mostrador", clockHands: "Ponteiros", clockBackground: "Fundo do relógio", clockBorder: "Borda do relógio", dateFormat: "Formato de data", clockSize: "Tamanho do relógio", dateSize: "Tamanho da data", worldClocks: "Relógios mundiais", timeZone: "Fuso horário", show: "Mostrar", clockAndDate: "Relógio e data", clockOnly: "Apenas relógio", dateOnly: "Apenas data", automatic: "Automático", dayMonthDate: "Dia, mês data", monthDayYear: "Mês dia, ano", ddmmyyyy: "DD/MM/AAAA" },
