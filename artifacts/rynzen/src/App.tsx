  ...
  return (
    ...
    >
        ...
        <div className="settings-body">
          ...
          {/* Appearance card */}
          <div className="settings-card" style={{ background: isDark ? "#252540" : "#f4f4f8" }}>
            <div className="settings-card-header" style={{ color: isDark ? "#e8e8f0" : "#1a1a2e" }}>
              Appearance
            </div>

            <div className="settings-row">
              <span className="settings-row-label" style={{ color: isDark ? "#ccd" : "#333" }}>Dark Mode</span>
              <button className={`toggle${darkMode ? " on" : ""}`} onClick={() => setDarkMode(!darkMode)} />
            </div>

            <div className="settings-row">
              <span className="settings-row-label" style={{ color: isDark ? "#ccd" : "#333" }}>Engine Color Effect</span>
          ...
          <div className="settings-card" style={{ background: isDark ? "#252540" : "#f4f4f8" }}>
            ...
            <div className="settings-row">
              <span className="settings-row-label" style={{ color: isDark ? "#ccd" : "#333" }}>Show Clock</span>
              ...
              <div className="settings-option-row">
                {(["small", "medium", "large"] as const).map((size) => (
                  <button
                    ...
                    style={{
                      background: clockSize === size ? selectedEngine.color : (isDark ? "#1e1e38" : "#e8e8ef"),
          ...
          <div className="settings-card" style={{ background: isDark ? "#252540" : "#f4f4f8" }}>
            ...
            <div className="settings-row">
              <span className="settings-row-label" style={{ color: isDark ? "#ccd" : "#333" }}>Show Quick Access</span>
          ...
          <div className="settings-card" style={{ background: isDark ? "#252540" : "#f4f4f8" }}>
            ...
            <div className="bg-presets">
              {bgPresets.map((p) => (
                <button
                  key={p.value}
                  className={`bg-swatch${bgColor === p.value ? " selected" : ""}`}
                  style={{ background: p.value, borderColor: bgColor === p.value ? selectedEngine.color : "transparent" }}
                  title={p.label}
                  onClick={() => {
                    setBgColor(p.value);
                    if (["#1a1a2e","#0d1117","#0a192f","#1b2f1b","#2d1b1b"].includes(p.value)) setDarkMode(true);
            ...
            <div className="settings-row">
              <span className="settings-row-label" style={{ color: isDark ? "#ccd" : "#333" }}>Custom color</span>
              <input
                type="color"
                value={bgColor}
          ...
          <div className="settings-card" style={{ background: isDark ? "#252540" : "#f4f4f8" }}>
            ...
            <input
              ...
              style={{ background: isDark ? "#1e1e38" : "#eeeef3", color: isDark ? "#e8e8f0" : "#1a1a2e", borderColor: "transparent" }}
          ...
          <button
            ...
            style={{ borderColor: isDark ? "#3a3a5c" : "#dde0e8", color: isDark ? "#889" : "#777" }}
          >
